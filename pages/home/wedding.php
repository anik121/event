        ...
        <div class="row">
            <div class="col-md-12">
                <div class="section-title mb60 text-center">
                    ...
                    <p>Many desktop publishing packages and web page editors now use orem psum as their default model
                        text.</p>
                </div>
            </div>
        </div>
        <div class="row ">
                ...
                <div class="vendor-box">
                    ...
                    <div class="vendor-detail">
                        ...
                        <div class="caption">
                            ...
                            <p class="location"><i class="fa fa-map-marker"></i> Street Address, Name of Town, 12345,
                                Country.</p>
                            <div class="rating"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                    class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i>
                                <span class="rating-count">(2)</span> </div>
                        </div>
                        <!-- /.caption -->
            ...
            <div class="col-md-4">
                ...
                <div class="vendor-box">
                    <div class="vendor-image">
                        <!-- vendor pic -->
                        <a href="#"><img src="./assets/images/vendor-4.jpg" alt="wedding vendor"
                                class="img-responsive"></a>
                    ...
                    <div class="vendor-detail">
                        ...
                        <div class="caption">
                            ...
                            <div class="rating"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                    class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i>
                                <span class="rating-count">(3)</span> </div>
                        </div>
                        <!-- /.caption -->
                        <div class="vendor-price">
            ...
            <div class="col-md-4 vendor-box">
                ...
                <div class="vendor-image">
                    <!-- vendor pic -->
                    <a href="#"><img src="./assets/images/vendor-3.jpg" alt="wedding vendor" class="img-responsive"></a>
